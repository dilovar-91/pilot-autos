<div class="bg-light border-right" id="sidebar-wrapper">
  ...
  <div class="list-group list-group-flush">
    ...
    <a href="https://auto.ru/" target="_blank" class="list-group-item list-group-item-action bg-light"><i class="fas fa-car-side"></i> Авто.ру</a>
    <a href="https://приставы.онлайн/" target="_blank" class="list-group-item list-group-item-action bg-light"><i class="fas fa-gavel"></i>Приставы онлайн</a>
